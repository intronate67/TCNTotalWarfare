...
public class Flag implements SubCommand {
    ...
    public String help(Player p) {
        return "/tw flag <id> <flag> <value> - " + SettingsManager.getInstance().getMessageConfig().getString("messages.help.flag", "Modifies an arena-specific setting");
    }

	@Override
	public String permission() {
		return "tw.admin.flag";
	}
}