package me.intronate67.TotalWarfare.hooks;

import java.util.HashMap;

import me.intronate67.TotalWarfare.SettingsManager;
import me.intronate67.TotalWarfare.util.MessageUtil;
...
public class HookManager {
	...
	public boolean checkConditions(String str,String... args){
		...
		for(String split:MessageUtil.replaceVars(str, args).split(";")){
			...
			if(!flag){
				System.out.println("[TotalWarfare][HookManager]Condition does not contian a compare operator: "+split);
				return false;
			}
			try{
				...
				System.out.println("[TotalWarfare][HookManager]Error parsing value for: "+split);
				return false;
			}
		}
		return true;
